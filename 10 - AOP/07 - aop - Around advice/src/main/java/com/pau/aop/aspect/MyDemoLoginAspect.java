...
//    @Before("execution(public void updateAccount())")
    ...
    @After(value="com.pau.aop.aspect.AOPExpressions.findAccountsAdvice()")
    public void performAfterFinallyAccountAdvice(JoinPoint joinPoint) {

        System.out.println("--------AfterFinally-----------");
        System.out.println("Aspect" + "performAfterFinallyAccountAdvice");
        System.out.println("Executed method " + joinPoint.toShortString());
        System.out.println("Args " + Arrays.toString(joinPoint.getArgs()));
        System.out.println("--------AfterFinally-----------");
    }
