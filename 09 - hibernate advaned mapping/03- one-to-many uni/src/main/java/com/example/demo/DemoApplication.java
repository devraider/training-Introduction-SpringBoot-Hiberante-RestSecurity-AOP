...
//			createCourseReviews(appDAO);
	...
	private void createCourseReviews(AppDAO appDAO) {
		Courses courses = new Courses("New Course PackMan");

		courses.addReview(new Review("Great spoken"));
		courses.addReview(new Review("Up"));
		courses.addReview(new Review("Bad (::)"));
